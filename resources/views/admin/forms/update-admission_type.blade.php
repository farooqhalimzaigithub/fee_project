      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row justify-content-center">
            <div  class="col-md-10">
              <div  class="card">
                <form  method="post" action="{{url('admission_type-edit',$admission_type->admission_id)}}" class="form-horizontal">
                    @csrf
                  <div class="card-body">
                    <h4 style="font-size: 30px;font-weight:bold" class="card-title">Fee Types Information</h4>
                    <div style="margin-top:40px" class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <select  value="{{$admission_type->admission_type}}" name="admission_type"  class="form-control">
...
{{--
        ...
        @foreach ($class as $classes )
                            ...
                            <tr>
                              <td>{{$classes->name}}</td>
                              <td><a class="btn btn-success" href="{{url('class-update',$classes->id)}}">Update</td>
                            <td><a class="btn btn-danger" href="{{url('class-delete',$classes->id)}}">Delete</td>
