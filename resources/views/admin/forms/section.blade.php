      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row justify-content-center">
            <div  class="col-md-11">
              <div  class="card">
                <form  method="post" action="{{url('section-upload')}}" class="form-horizontal">
                    @csrf
                  <div class="card-body">
                    <h4 style="font-size: 30px;font-weight:bold" class="card-title"> Section Information</h4>
        ...
        @foreach ($section as $sections)
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="{{url('section-update',$sections->section_id)}}"><i class="far fa-edit text text-success"></i></a>
                                <a style="margin-left: 10px" href="{{url('section-delete',$sections->section_id)}}"><i class="far fa-trash-alt text text-danger"></i></a>
                             </td>
                            </tr>
