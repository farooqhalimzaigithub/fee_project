      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row justify-content-center">
            <div  class="col-md-11">
              <div  class="card">
                <form  method="post" action="{{url('fee_category-upload')}}" class="form-horizontal">
                    @csrf
                  <div class="card-body">
                    <h4 style="font-size: 30px;font-weight:bold" class="card-title"> Fee Category Information</h4>
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                        ...
                        >
                          ...
                          <tbody>
        @foreach ($fee_category as $fee_categorys)


                            <tr>
                              <td>{{$fee_categorys->tuition_fee}}</td>
                              <td>
                              ...
                              <td>
                                <a href="{{url('fee_category-update',$fee_categorys->category_id)}}"><i class="far fa-edit text text-success"></i></a>
                                <a style="margin-left: 10px" href="{{url('fee_category-delete',$fee_categorys->category_id)}}"><i class="far fa-trash-alt text text-danger"></i></a>
                             </td>
                            </tr>
