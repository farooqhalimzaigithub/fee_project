      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row justify-content-center">
            <div  class="col-md-11">
              <div  class="card">
                <form  method="post" action="{{url('fee_master-upload')}}" class="form-horizontal">
                    @csrf
                  <div class="card-body">
                    <h4 style="font-size: 30px;font-weight:bold" class="card-title"> Fee Master Information</h4>
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                        ...
                        >
                          ...
                          <tbody>
        @foreach ($fee_master as $fee_masters)


                            <tr>
                              <td>{{$fee_masters->fee_type_id}}</td>
                              <td>{{$fee_masters->class_id}}</td>
                              <td>{{$fee_masters->amount}}</td>
                              ...
                              <td>
                                <a href="{{url('fee_master-update',$fee_masters->fee_master_id)}}"><i class="far fa-edit text text-success"></i></a>
                                <a style="margin-left: 10px" href="{{url('fee_master-delete',$fee_masters->fee_master_id)}}"><i class="far fa-trash-alt text text-danger"></i></a>
                             </td>
                            </tr>
