      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row justify-content-center">
            <div  class="col-md-11">
              <div  class="card">
                <form  method="post" action="{{url('fee_types-upload')}}" class="form-horizontal">
                    @csrf
                  <div class="card-body">
        ...
        @foreach ($fee_types as $fee)
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="{{url('fee_types-update',$fee->fee_type_id)}}"><i class="far fa-edit text text-success"></i></a>
                                <a style="margin-left: 10px" href="{{url('fee_types-delete',$fee->fee_type_id)}}"><i class="far fa-trash-alt text text-danger"></i></a>
                             </td>
                            </tr>
