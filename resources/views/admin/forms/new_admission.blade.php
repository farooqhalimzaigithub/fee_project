      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row justify-content-center">
            <div  class="col-md-11">
              <div  class="card">
                <form  method="post" action="{{url('new_admission-upload')}}" class="form-horizontal">
                    @csrf
                  <div class="card-body">
                    <h4 style="font-size: 30px;font-weight:bold" class="card-title">New Admission Information</h4>
                      ...
                      <div style="margin-top:40px" class="form-group row">
                        ...
                        <div class="col-sm-7">
                          <select name="admission_type"  class="form-control">
                              ...
                              <option value="For Promotes new admission">For Promotes new admission</option>
                              <option value="For only new admission">For only new admission</option>
                              <option value="For only Promoted">For only Promoted</option>
                          </select>
                        </div>
                      </div>
                        ...
                        >
                          <thead>
                            <tr>
                              ...
                              <th style="font-weight:bold">Mobile_no</th>
                              <th style="font-weight:bold" >Class</th>
                              <th style="font-weight:bold">Section</th>
                              <th style="font-weight:bold">Gurdain</th>
                              <th style="font-weight:bold" >Roll No</th>
                              <th style="font-weight:bold">Category</th>
                              <th style="font-weight:bold" >Address</th>
                              <th style="font-weight:bold">City</th>
                              <th style="font-weight:bold" >Admission Date</th>
                              <th style="font-weight:bold">Sibling</th>
                              <th style="font-weight:bold">Admission Type</th>
                          ...
                          <tbody>
        @foreach ($new_admission as $new_admissions)


                            <tr>
                              <td>{{$new_admissions->first_name}}</td>
                              <td>{{$new_admissions->last_name}}</td>
                              <td>{{$new_admissions->dob}}</td>
                              <td>{{$new_admissions->mobile_no}}</td>
                              <td>{{$new_admissions->class_id}}</td>
                              <td>{{$new_admissions->section_id}}</td>
                              <td>{{$new_admissions->gurdain_name}}</td>
                              <td>{{$new_admissions->roll_no}}</td>
                              <td>{{$new_admissions->category}}</td>
                              <td>{{$new_admissions->address}}</td>
                              <td>{{$new_admissions->city}}</td>
                              <td>{{$new_admissions->admission_date}}</td>
                              <td>{{$new_admissions->subling}}</td>
                              <td>{{$new_admissions->admission_type}}</td>



                              {{-- <td>
                                @if($fee_categorys->status=="1")
                                <button class="btn btn-success text-white">Active</button>
                                @else
                                <button class="btn btn-danger text-white">Inactive</button>

                                @endif
                              </td> --}}
                              <td>
                                <a href="{{url('new_admissions-update',$new_admissions->new_admission_id)}}"><i class="far fa-edit text text-success"></i></a>
                                <a style="margin-left: 10px" href="{{url('new_admissions-delete',$new_admissions->new_admission_id)}}"><i class="far fa-trash-alt text text-danger"></i></a>
                             </td>
                            </tr>
