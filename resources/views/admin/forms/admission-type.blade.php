      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row justify-content-center">
            <div  class="col-md-10">
              <div  class="card">
                <form  method="post" action="{{url('admission_type-upload')}}" class="form-horizontal">
                    @csrf
                  <div class="card-body">
                    <h4 style="font-size: 30px;font-weight:bold" class="card-title">Admission Type Information</h4>
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                        ...
                        >
                          ...
                          <tbody>
        @foreach ($admission_type as $admission_types)


                            <tr>
                              <td>{{$admission_types->admission_type}}</td>
                              {{-- <td>
                                @if($admission_types->status=="1")
                                Active
                                @else
                                Inactive
                                @endif
                              ...
                              <td>
                                <a href="{{url('admission_type-update',$admission_types->admission_id)}}"><i class="far fa-edit text text-success"></i></a>
                                <a style="margin-left: 10px" href="{{url('admission_type-delete',$admission_types->admission_id)}}"><i class="far fa-trash-alt text text-danger"></i></a>
                             </td>
                            </tr>
