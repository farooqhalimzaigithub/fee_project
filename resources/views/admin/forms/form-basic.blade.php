      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row justify-content-center">
            <div  class="col-md-10">
              <div  class="card">
                <form  method="post" action="{{url('class-upload')}}" class="form-horizontal">
                    @csrf
                  <div class="card-body">
                    <h4 style="font-size: 30px;font-weight:bold" class="card-title"> Class Information</h4>
        ...
        @foreach ($class as $classes)
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="{{url('class-update',$classes->class_id)}}"><i class="far fa-edit text text-success"></i></a>
                                <a style="margin-left: 10px" href="{{url('class-delete',$classes->class_id)}}"><i class="far fa-trash-alt text text-danger"></i></a>
                             </td>
                            </tr>
